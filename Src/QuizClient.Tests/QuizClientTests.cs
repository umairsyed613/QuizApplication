    ...
    public class QuizClientTests : IClassFixture<QuizServiceApiPact>
    {
        ...
        public async Task GetQuizzes_WhenSomeQuizzesExists_ReturnsTheQuizzes()
        {
            _mockProviderService
               ...
               .With(new ProviderServiceRequest { Method = HttpVerb.Get, Path = "/api/quizzes", Headers = new Dictionary<string, object> { { "Accept", "application/json" } } })
        ...
        public async Task GetQuiz_WhenAQuizWExists_ReturnsTheQuiz()
        {
            _mockProviderService
               ...
               .With(new ProviderServiceRequest { Method = HttpVerb.Get, Path = "/api/quizzes/123", Headers = new Dictionary<string, object> { { "Accept", "application/json" } } })
               .WillRespondWith(new ProviderServiceResponse
                {
                    Status = 200,
                    Headers = new Dictionary<string, object> { { "Content-Type", "application/json; charset=utf-8" } },
                    Body = new { id = 123, title = "This is quiz 123" }
                });
        ...
        public async Task PostQuiz_Returns201CreatedAndLocationHeader()
        {
            _mockProviderService
               ...
               .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Post, Path = "/api/quizzes", Headers = new Dictionary<string, object> { { "Content-Type", "application/json" } }
                })
               .WillRespondWith(new ProviderServiceResponse
                {
                    Status = 201,
                    ...
                    {
                        { "Content-Type", "application/json" }, { "Location", PactNet.Matchers.Match.Regex("/api/quizzes/1", "quizzes\\/[0-9]*") }
                    }
                });
        ...
        public async Task PostQuestion_Returns201CreatedAndLocationHeader()
        {
            _mockProviderService
               ...
               .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Post, Path = "/api/quizzes/123/questions", Headers = new Dictionary<string, object> { { "Content-Type", "application/json" } }
                })
               .WillRespondWith(new ProviderServiceResponse
                {
                    Status = 201,
        ...
        public async Task PutQuestion_WhenAQuestionWExists_UpdatesTheQuestion()
        {
            _mockProviderService
               ...
               .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Put, Path = "/api/quizzes/123/questions/1", Headers = new Dictionary<string, object> { { "Content-Type", "application/json" } }
                })
               .WillRespondWith(new ProviderServiceResponse { Status = 204, Headers = new Dictionary<string, object> { { "Content-Type", "application/json; charset=utf-8" } } });
               ...
               .WillRespondWith(new ProviderServiceResponse
                {
                    ...
                    Body = new { title = "This is quiz 999" }
                });
        ...
        public async Task GivenThatAQuizExistsPostingAnAnswerCreatesAQuizResponse()
        {
            _mockProviderService
               ...
               .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Post, Path = "/api/quizzes/123/responses", Headers = new Dictionary<string, object> { { "Content-Type", "application/json" } }
                })
               .WillRespondWith(new ProviderServiceResponse
                {
                    Status = 201,
